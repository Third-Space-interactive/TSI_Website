        ...
        <div id="video-frame" className='relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75'>
            ...
            <div className="absolute left-0 top-0 z-40 size-full">
                <div className="mt-24 px-5 sm:px-10">
                    <h1 className="special-font hero-heading text-blue-100"><b>T</b>hird Sp<b>a</b>ce</h1>
                    <p className="mb-5 max-w-64 font-robert-regular text-blue-100">Where game-engine visualization meets architectural realization</p>
